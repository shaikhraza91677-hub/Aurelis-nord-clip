...
from job_manager import _handler,get,list_jobs,run_redis_worker_forever,submit

def submit_job(kind,payload):return submit(kind,payload,lambda:_handler(kind,payload))
